define(["subscribers"],function (subscribers){
	...
	Account.prototype.editTransaction = function(id, amt, date, type, memo) {
	...
	Account.prototype.deleteTransaction=function(id, amt, date, type, memo){
		for (var i = 0; i < this.transactions.length; i += 1) {
			//if passed id === transactions.id in array
			if (id === this.transactions[i].id) {
				prompt("Delete transaction: " + this.transactions[i].amount)
				+ ", " + this.transactions[i].date + ", "
				+ this.transactions[i].type + ", " + this.transactions[i].memo;
