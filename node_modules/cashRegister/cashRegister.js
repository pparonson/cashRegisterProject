define(["subscribers"],function (subscribers){
	...
	Account.prototype.sortTransactionDate = function() {
	...
	Transaction.prototype.toString = function() {
		var str ="Transaction: (Date: " + this.date;
		if (this.memo!=="")
			str+=", Memo: "+this.memo;
		if (this.amount<0)
			str+=", Amount: -$"+this.amount*-1+")";
		else str+=", Amount: $"+this.amount+")";
		return str;
	};//end: fn
